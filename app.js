...
const conn_str="mongodb+srv://monica:monica1947@cluster0.l0f5hos.mongodb.net/college?retryWrites=true&w=majority"
...
// //cw create add(a,b) function with 2 parameter which will print addition of 2 number
// var add=(a, b)=>{
//     console.log(`${a} + ${b} = ${a+b}`);
// }

// //cw create sub(a,b) function with 2 parameter which will print substraction of 2 number
// var sub=(a, b)=>{
//     console.log(`${a} - ${b} = ${a-b}`);
// }

// //create calc(a,b,op) function with 3parameter which will accept 2 number and one callback function
// var calc=(a,b,op)=>{
//     op(a,b);
// }
